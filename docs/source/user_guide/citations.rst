...
RAIL is open source and may be used according to the terms of its `LICENSE
<https://github.com/LSSTDESC/RAIL/blob/main/LICENSE>`_ (`BSD 3-Clause
<https://opensource.org/licenses/BSD-3-Clause>`_).

If you used RAIL in your study, please cite `this repository
<https://github.com/LSSTDESC/RAIL>`_ and `RAIL Team et al. (2025)
<https://arxiv.org/abs/2505.02928>`_:
...
methods are used in a publication:
