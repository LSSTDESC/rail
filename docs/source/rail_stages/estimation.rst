...
2017](https://academic.oup.com/mnras/article/499/2/1587/5905416), [Dalmasso et
al., 2020](https://academic.oup.com/mnras/article/499/2/1587/5905416)) is an
...
[Almosallam et al. (2016)](https://arxiv.org/abs/1604.03593). The current `rail`
...
versions of `GPz` ([Stylianou et al., 2022](https://arxiv.org/abs/2202.12775)).
...
(1999)](https://ui.adsabs.harvard.edu/abs/1999MNRAS.310..540A) and further
developed by [Ilbert et al.
(2006)](https://ui.adsabs.harvard.edu/abs/2006A%26A...457..841I). It is written
...
(2022)](https://ui.adsabs.harvard.edu/abs/2022ApJS..258...11W). The full set of
...
[`minisom`](https://pypi.org/project/MiniSom/), and `somoclu_som` using the
[`somoclu`](https://somoclu.readthedocs.io/en/stable/) package.
...
[`yet_another_wizz`](https://github.com/jlvdb/yet_another_wizz) (YAW; [van den
Busch et al., 2020](https://ui.adsabs.harvard.edu/abs/2020A%26A...642A.200V)).
We provide a wrapper in `cc_yaw`.

This wrapper consists of a number of stages that interface with all primary YAW
functionality:

- `YawCacheCreate`: Data preparation — splitting input data samples into regions
  for spatial resampling and covariance estimation.
- `YawAutoCorrelate`: Measurement of the angular autocorrelation function
...
- `YawSummarize`: Estimation of the ensemble redshift distribution according to
